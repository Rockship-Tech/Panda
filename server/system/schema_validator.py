...
#     except TypeError:
#         raise UserInputInvalid(
#             f"'{value}' must respect datetime format '{DATE_FORMAT}'"
#         )
...
#     except TypeError:
#         raise UserInputInvalid(
#             f"'{value}' must respect datetime format '{DATETIME_FORMAT}'"
#         )
...
#         raise UserInputInvalid(
#             f"Invalid Timezone: {value}. Must be in {valid_timezones}"
#         )
#     return value
